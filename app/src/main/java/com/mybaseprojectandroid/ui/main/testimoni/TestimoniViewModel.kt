...
class TestimoniViewModel(val rvVideoTesti : RecyclerView) : ViewModel() {
    ...
    fun setData(){
        listTestimoni.add(Testimoni("aEDvBeS7qbg","10 MANFAAT BERJALAN KAKI SECARA TERATUR","Video informasi & edukasi yang menjelaskan tentang 10 manfaat yang didapatkan dengan rutin berjalan kaki."))
        ...
        listTestimoni.add(Testimoni("JsZ1BywbDfQ","Keajaiban Jalan Kaki Bagi Kesehatan","Jalan kaki adalah jenis olahraga yang gampang dilakukan, hemat, dan bisa dilakukan oleh semua orang,\n" +"mulai dari anak-anak hingga mereka yang menginjak usia senja."))
